...
public class RatioPrinter : Printer
{
    ...
    void Start()
    {
        ...
        playerADeck = CardData.LoadDeckFromJson("Assets/Decks/spelltest3.json");
        playerBDeck = CardData.LoadDeckFromJson("Assets/Decks/spelltest3.json");
